...
public class VerifikasiPulangActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener{
    @BindView(R.id.btnVerifikasiPulang)
    Button verifikasiPulang;

    private GoogleMap mMap;
    private static final String TAG = "VerifikasiPulangActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verifikasi_pulang);
        ...
        verifikasiPulang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(VerifikasiPulangActivity.this, AbsenPulangActivity.class));
            }
        });
    }
