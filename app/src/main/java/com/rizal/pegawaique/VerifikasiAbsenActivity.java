...
public class VerifikasiAbsenActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    @BindView(R.id.btnVerifikasi)
    Button verifikasi;

    private GoogleMap mMap;
    private static final String TAG = "VerifikasiAbsenActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verifikasi_absen);
        ...
        verifikasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(VerifikasiAbsenActivity.this, AbsenMasukActivity.class));
            }
        });
    }
